...
--
-- Name: foo; Type: TABLE; Schema: public; Owner: pascal; Tablespace: 
--
...
ALTER TABLE public.foo OWNER TO pascal;
...
--
-- Data for Name: foo; Type: TABLE DATA; Schema: public; Owner: pascal
--

COPY foo (idx, name) FROM stdin;
1	kkmm
2	kkssmm
3	qsfdfs
\.
...
--
-- Name: foo_pkey; Type: CONSTRAINT; Schema: public; Owner: pascal; Tablespace: 
--
